...
ZNF714.peaks = ZNF714.peaks[order(ZNF714.peaks$score, decreasing = TRUE)[1:500]] %>%
               TECookbook::annotateSitesInRepeat(AnnotationData = Repeats.Human.hg19,
                                                   output = "all")
ZNF714.peaks %>%
  as_tibble()  %>%
...
ZNF431.peaks = TECookbook::annotateSitesInRepeat(ZNF431.peaks, AnnotationData = Repeats.Human.hg19,
                                                   output = "all")
...
ZNF430.peaks = TECookbook::annotateSitesInRepeat(mySiteList = ZNF430.peaks,
                                                   AnnotationData = Repeats.Human.hg19,
                                                   output = "all")
